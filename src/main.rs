...
fn main()
{
    ...
    simple_numbers_find(100000, &mut vector_of_numbers);

    simple_numbers_print_from_vector(&vector_of_numbers);

    // simple_numbers_find_integrated(10000);
}

fn simple_numbers_find_integrated(end_of_the_interval: i32)
{
...
fn simple_numbers_find(end_of_the_interval: i32,  vector_to_store: &mut Vec<i32>)
{
...
fn simple_numbers_print_from_vector(vector_to_print: &Vec<i32>)
{
    print!("1");
